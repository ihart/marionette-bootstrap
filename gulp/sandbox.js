...
var paths = {
  src: './static/app/sandbox/sandbox.js',
  dest: 'static/dist'
};
...
function bundleApp () {
  ...
  generateBundle(appBundler, 'sandbox-bundled.js', 'watchify');
...
gulp.task('scripts:sandbox', function(done) {
...
gulp.task('watch:sandbox-scripts', function() {
