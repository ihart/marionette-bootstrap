...
module.exports = app;
},{"./chrome/chrome":24,"./util/event-bus":38,"./util/handlebars-helpers":39,"backbone.marionette":"backbone.marionette","jQuery":21}],23:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<section data-region=\"region-content\"></section>";
},"useData":true});
...
},{"../router/router":28,"../scene/scene":30,"../state-machine/state-machine":37,"./chrome.hbs":23,"backbone":"backbone","backbone.marionette":"backbone.marionette","jQuery":21}],25:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"1":function(container,depth0,helpers,partials,data) {
    var stack1;

  return ((stack1 = container.invokePartial(partials.icon,(depth0 != null ? depth0.icon : depth0),{"name":"icon","data":data,"helpers":helpers,"partials":partials,"decorators":container.decorators})) != null ? stack1 : "");
},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    var stack1, helper, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression;

  return "<span class=\"Button-label\" data-button=\""
...
},{"./button.hbs":25,"backbone":"backbone","backbone.marionette":"backbone.marionette"}],27:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
  ...
  return "<svg class=\"Icon Icon--"
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\" role=\"img\"><use xlink:href=\"/dist/svg-symbols.svg#"
    + alias4(((helper = (helper = helpers.id || (depth0 != null ? depth0.id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"id","hash":{},"data":data}) : helper)))
    + "\"></use></svg>\n";
},"useData":true});
...
},{"../util/event-bus":38,"backbone":"backbone"}],29:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "<div class=\"Scene\" data-region-scene=\"welcome\"></div>\n<div class=\"Scene\" data-region-scene=\"about\"></div>\n<div class=\"Scene\" data-region-scene=\"finish\"></div>";
},"useData":true});
...
},{"../router/router":28,"../util/event-bus":38,"./scene.hbs":29,"./scenes/about/about":32,"./scenes/finish/finish":34,"./scenes/welcome/welcome":36,"backbone.marionette":"backbone.marionette","jquery":"jquery","underscore":"underscore"}],31:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "About\n<br><br>\n<div data-region=\"btn-next\"></div>";
},"useData":true});
...
},{"../../../components/button/button":26,"../../../util/event-bus":38,"./about.hbs":31,"backbone":"backbone","backbone.marionette":"backbone.marionette"}],33:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "Finish";
...
},{"./finish.hbs":33,"backbone":"backbone","backbone.marionette":"backbone.marionette"}],35:[function(require,module,exports){
// hbsfy compiled Handlebars template
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
    return "Welcome\n<br><br>\n<div data-region=\"btn-next\"></div>";
...
},{"../../../components/button/button":26,"../../../util/event-bus":38,"./welcome.hbs":35,"backbone":"backbone","backbone.marionette":"backbone.marionette"}],37:[function(require,module,exports){
'use strict';
...
},{"../util/event-bus":38,"backbone":"backbone","underscore":"underscore"}],38:[function(require,module,exports){
'use strict';
